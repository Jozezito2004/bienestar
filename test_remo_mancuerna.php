<?php
$page_title = "Test de Remo con Mancuerna - Bienestar BUAP";
include 'header.php';
include 'navbar.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($repeticiones <= 0) {
        ...
        $stmt = $conexion->prepare("INSERT INTO pruebas_actividad_fisica (id_colaborador, fecha_evaluacion, remo_mancuerna, remo_mancuerna_hr) VALUES (?, ?, ?, ?) ON DUPLICATE KEY UPDATE remo_mancuerna = ?, remo_mancuerna_hr = ?");
...
<div class="container mt-4">
    <div class="card">
        <div class="card-body">
            <h1 class="card-title">Test de Remo con Mancuerna (NSCA)</h1>
            ...
            <form method="POST" action="test_remo_mancuerna.php?id=<?php echo $id_colaborador; ?>">
                <div class="form-group">
                    <label for="repeticiones">Número de Repeticiones (promedio de ambos brazos):</label>
