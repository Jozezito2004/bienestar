<?php
$page_title = "Test de Flexiones de Pecho - Bienestar BUAP";
include 'header.php';
include 'navbar.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($repeticiones <= 0) {
        ...
        $stmt = $conexion->prepare("INSERT INTO pruebas_actividad_fisica (id_colaborador, fecha_evaluacion, flexiones_pecho, flexiones_pecho_hr) VALUES (?, ?, ?, ?) ON DUPLICATE KEY UPDATE flexiones_pecho = ?, flexiones_pecho_hr = ?");
...
<div class="container mt-4">
    <div class="card">
        <div class="card-body">
            <h1 class="card-title">Test de Flexiones de Pecho (ACSM)</h1>
            ...
            <form method="POST" action="test_flexiones_pecho.php?id=<?php echo $id_colaborador; ?>">
